#TODO: uncomment for creating new user
...
$pass = "SomePassword2014" | convertto-securestring -asplaintext -force
$cred = new-object -typename System.Management.Automation.PSCredential -argumentlist $user, $pass

#generate Win8.1 provision script
'echo $env:USERNAME
...
#Installing nodejs; Chocolatey cannott install it successfully under SYSTEM account
...
$x = $host.UI.RawUI.ReadKey("NoEcho,IncludeKeyDown")' > "C:\mytemp\provision81.ps1"

$arglist = "C:\mytemp\provision81.ps1"
