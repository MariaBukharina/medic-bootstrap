...
New-ItemProperty -Path registry::HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\RunOnce -Name Installer -Value 'powershell "C:\mytemp\medic-bootstrap\autologon.ps1"'
